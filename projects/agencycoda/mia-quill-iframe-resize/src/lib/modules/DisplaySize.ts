...
export class DisplaySize extends BaseModule {
    ...
    public onUpdate(): void {
        ...
        else if (this.iframe.style['float'] === 'right') {
    ...
    private getCurrentSize(): number[] {
        return [
            parseInt(this.iframe.style.width.replace('px', '')),
            parseInt(this.iframe.style.height.replace('px', ''))
        ];
    }
